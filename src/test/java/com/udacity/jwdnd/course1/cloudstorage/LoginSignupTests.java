...
class LoginSignupTests {
    ...
    public void testSignUpLoginLogout() {
        ...
        signupPage.setFirstName("Ahmed");
        signupPage.setLastName("Aly");
        signupPage.setUserName("ahmedaly");
        signupPage.setPassword("20212022");
        signupPage.signUp();
        ...
        loginPage.setUserName("ahmedaly");
        loginPage.setPassword("20212022");
        loginPage.login();
